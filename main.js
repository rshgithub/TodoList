...
function renderTodo(todo) {
    ...
    node.innerHTML = `
          <input  type="checkbox" class="checkbox" id="checkbox-${todo.id}" name="${todo.id}">
           <label style="background-color: white" class="todos-list__li" for="${todo.id}">
           ...
           <button class="todos-list__li-delete-todo " style="background-color: white"><i class=" fa fa-close fa-2x" style="color:red; "></i>  </button>
           </label>
        `;
    console.log(node);
    list.append(node);
